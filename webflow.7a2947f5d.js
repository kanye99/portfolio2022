!function(t) {
  ...
  i.resize = z(u, k),
  i.scroll = z(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"),
  i.redraw = z(),
  ...
  window.tram = function(t) {
      ...
      if (A.transition) {
          var $ = A.timing.dom;
          if (T.style[$] = f["ease-in-back"][0], !T.style[$])
              for (var M in h)
                  f[M][0] = h[M]
      }
      var B = e.frame = function() {
          ...
          R = l(function(e) {
              ...
              function d(t, e, i) {
                  ...
                  for (o in t)
                      s = t[o],
                      o in Q ? (l.transform || (l.transform = {}), l.transform[o] = s) : (w.test(o) && (o = n(o)), o in Z ? l[o] = s : (u || (u = {}), u[o] = s));
                  for (o in l) {
              ...
              e.init = function(e) {
                  ...
                  A.backface && U.hideBackface && X(this.el, A.backface.css, "hidden")
              },
              b("add", r),
              b("start", o),
              b("wait", function(t) {
          ...
          D = l(function(t) {
              ...
              t.init = function(t, e, n, i) {
                  ...
                  U.fallback || i.fallback ? this.animate = this.fallback : (this.animate = this.transition, this.string = this.name + E + this.duration + "ms" + ("ease" != this.ease ? E + f[this.ease][0] : "") + (this.delay ? E + this.delay + "ms" : ""))
              },
              t.set = function(t) {
          ...
          C = l(D, function(t, e) {
              ...
              t.init = function() {
                  e.init.apply(this, arguments),
                  this.current || (this.current = {}, Q.perspective && U.perspective && (this.current.perspective = U.perspective, X(this.el, this.name, this.style(this.current)), this.redraw()))
              },
              t.set = function(t) {
          ...
          H = l(function(e) {
              ...
              e.play = function() {
                  var t;
                  this.active || (this.start || (this.start = F()), this.active = !0, t = this, 1 === u.push(t) && B(n))
              },
              e.stop = function() {
                  var e,
                      n,
      ...
      var X = t.style,
          ...
          Z = {
              ...
              "max-height": [D, x],
              "line-height": [D, k],
              "scroll-top": [P, g, "scrollTop"],
              "scroll-left": [P, g, "scrollLeft"]
          },
          Q = {};
      A.transform && (Z.transform = [C], Q = {
          x: [x, "translateX"],
          y: [x, "translateY"],
          rotate: [_],
          rotateX: [_],
      ...
      A.transform && A.backface && (Q.z = [x, "translateZ"], Q.rotateZ = [_], Q.scaleZ = [g], Q.perspective = [y]);
      var J = /ms/,
          V = /s|\./;
      return t.tram = e
  }(window.jQuery)
  ...
  i.define("brand", t.exports = function(t) {
      ...
      return n.ready = function() {
          ...
          s && !c && (e = e || (n = t('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs"), i = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-icon.f67cd735e3.svg").css({
              marginRight: "8px",
              width: "16px"
      ...
      function j(e, i, r, o) {
          ...
          if (!n || r.force) {
              ...
              if (d && d.length) {
                  if (d.length < 2 && (l = !1), !o) {
                      var p = e.selector;
                      p && (i = e.descend ? i.find(p) : e.siblings ? i.siblings(p) : t(p), f && i.attr("data-ix-affect", 1)),
